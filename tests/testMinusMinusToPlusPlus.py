...
class MutatorTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.m = all_mutants["ArithmeticDecrementToIncrement"]  ##Insert Regex here...

    def test_StringWithSingleMinus__ReturnsUnchanged(self):
        str = "100 - 90 - 80 - 70"
    ...
    def test_GetName(self):
        self.assertEqual("ArithmeticDecrementToIncrement", self.m.get_name())
